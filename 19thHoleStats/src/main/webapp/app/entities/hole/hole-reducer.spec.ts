...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './hole.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOLE actions', async () => {
      const expectedActions = [
        {
