...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './scorecard.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCORECARD_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCORECARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCORECARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCORECARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCORECARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCORECARD actions', async () => {
      const expectedActions = [
        {
