...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './round.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROUND_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROUND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROUND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROUND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROUND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROUND actions', async () => {
      const expectedActions = [
        {
