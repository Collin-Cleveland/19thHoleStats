...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './golfer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GOLFER_LIST actions', async () => {
    ...
    it('dispatches FETCH_GOLFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GOLFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GOLFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GOLFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GOLFER actions', async () => {
      const expectedActions = [
        {
