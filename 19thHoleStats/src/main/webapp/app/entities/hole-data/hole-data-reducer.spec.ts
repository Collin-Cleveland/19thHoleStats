...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './hole-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOLEDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOLEDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOLEDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOLEDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOLEDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOLEDATA actions', async () => {
      const expectedActions = [
        {
